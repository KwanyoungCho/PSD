...
**⑥ 예산 슬롯의 P_iv↔hit (2026-08-04 추가 — 사용자 질의; 재현:
e1_feasibility/e0_budget_piv_analysis.py)**: dedup 후 실제 예산 10슬롯
기준 — [0.3,1) hit 0.308 / [0.1,0.3) 0.095 / <0.01은 0.002 이하.
**예산의 41.5%(P_iv<0.01)가 hit 기여 3.9%뿐, 68.3%(<0.03)가 15.5%**
— 슬롯 4~7개가 사실상 사망. 예산-내 상위 3슬롯이 hit의 75.2%, 상위
5가 86.8% 커버. wire 상위(④ rank1 0.416)와의 괴리 원인 = **wire
최상위는 P1과 중복되어 dedup으로 소거** (예산 1위 P_iv 중앙값 0.139).
스텝당 기대 hit 0.251 = 실측 P2 hit 정확 재현 (자기검증). 함의:
root_count 집중(top-5)은 hit -13% vs per-hit +19% (#26)로 소폭 우세,
zero-valid 무효화가 <0.003 슬롯에 닿으면 손실 0.8%뿐.
