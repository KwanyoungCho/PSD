...
def set_context(is_prefill, cu_seqlens_q=None, cu_seqlens_k=None, max_seqlen_q=0, max_seqlen_k=0, slot_mapping=None, context_lens=None, block_tables=None, is_jit=False, active_mq_len=None, active_wrappers=None, active_layout=None, glue_valid_k=None, hybrid_graph_key=None, active_cache_hits_list=None):
    global _CONTEXT
    _CONTEXT = Context(is_prefill, is_jit, cu_seqlens_q, cu_seqlens_k, max_seqlen_q, max_seqlen_k, slot_mapping, context_lens, block_tables, active_mq_len, active_wrappers, active_layout, glue_valid_k, hybrid_graph_key, active_cache_hits_list)
