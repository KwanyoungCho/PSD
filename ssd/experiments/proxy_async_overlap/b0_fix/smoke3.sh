#!/usr/bin/env bash
# Smoke test v2 — sane (dfo, pfo, f) that originally ran ~22 min before crashing.
# (dfo=4, pfo=1, f=5): lookahead = 15 + 14×75 = 1065 slots. With input 512
# + output 128 = 640 tokens, plenty of headroom in max_model_len=2048.

set -euo pipefail

ROOT="/home/chokwans99/PSD/ssd"
PHASE_DIR="${ROOT}/experiments/proxy_async_overlap/b0_fix/smoke3"
PY="/home/chokwans99/anaconda3/envs/ssd/bin/python"

cd "${ROOT}"

export CUDA_VISIBLE_DEVICES=0,1,2,3,4
export SSD_DIST_PORT=12657
...
echo "[$(date -Is)] === SMOKE3 (dfo=${DFO}, pfo=${PFO}, f=${F}) ==="
"${PY}" -O bench/bench.py \
  --llama --size 8 \
