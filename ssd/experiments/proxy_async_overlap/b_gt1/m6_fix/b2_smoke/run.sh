#!/usr/bin/env bash
# M6 fix validation — B=2 smoke, identical to m4_smoke_b2 (champion
# E9K24_jit, b=2 ns=8 out=128) except port 12910. PASS bar: L_p2 >= 1.3
# (vs bugged 0.92/0.85) and tok-on-miss recovering toward ~2.5.
set -euo pipefail
ROOT="/home/chokwans99/PSD/ssd"
OUT="${ROOT}/experiments/proxy_async_overlap/b_gt1/m6_fix/b2_smoke"
PY="/home/chokwans99/anaconda3/envs/ssd/bin/python"
cd "${ROOT}"
export CUDA_VISIBLE_DEVICES=0,1,2,3,4
export SSD_DIST_PORT=12910
...
SSD_FORCE_SPLIT_K1K2=1 SSD_DUET_JIT_SHORT=1 \
  ...
  --gpus 5 --b 2 --temp 0.7 --seed 42 --numseqs 8 \
