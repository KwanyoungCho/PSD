#!/usr/bin/env bash
# M4 B=1 regression smoke — champion E9K24_jit config, ns=4 out=128 (same as M3).
set -euo pipefail
ROOT="/home/chokwans99/PSD/ssd"
OUT="${ROOT}/experiments/proxy_async_overlap/b_gt1/m4_smoke_b1"
PY="/home/chokwans99/anaconda3/envs/ssd/bin/python"
cd "${ROOT}"
export CUDA_VISIBLE_DEVICES=0,1,2,3,4
export SSD_DIST_PORT=12896
