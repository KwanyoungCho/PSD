...
for r in 1 2 3; do
  duet_ab k1x1_base_r${r} 1 1 5 1 0
  duet_ab k1x1_sub_r${r}  1 1 5 1 1
done
for r in 1 2 3; do
  duet_ab k2x2_base_r${r} 2 2 4 1 0
  duet_ab k2x2_sub_r${r}  2 2 4 1 1
done
echo "[$(date -Is)] === JIT_SUBSET AB DONE ==="
