...
echo "[$(date -Is)] === RESUME A: cb16_k3f3 retry + B=32 C grid ==="
c_cell 16 3 3 16
c_cell 32 3 6 32
c_cell 32 5 6 32
c_cell 32 5 3 32
...
c_cell 32 2 3 32
c_cell 32 2 2 32
echo "[$(date -Is)] === PHASE A DONE (resume) ==="

echo "[$(date -Is)] === PHASE B: DUET B=16/32 scan ==="
duet_cell db16_k2x2_d5p1 16 2 2 5 1 16
duet_cell db16_k2x2_d4p1 16 2 2 4 1 16
duet_cell db16_k3x3_d4p1 16 3 3 4 1 16
duet_cell db16_k1x1_d5p1 16 1 1 5 1 16
duet_cell db32_k2x2_d5p1 32 2 2 5 1 32
duet_cell db32_k2x2_d4p1 32 2 2 4 1 32
duet_cell db32_k1x1_d5p1 32 1 1 5 1 32
duet_cell db32_k1x1_d7p1 32 1 1 7 1 32
echo "[$(date -Is)] === PHASE B DONE ==="
echo "[$(date -Is)] === RESUME AB ALL DONE ==="
