...
echo "[$(date -Is)] === EDGE C cells (rule: shallowest won) ==="
c_cell 16 2 3 16
c_cell 16 2 2 16
c_cell 32 2 1 32

echo "[$(date -Is)] === EDGE DUET dfo cells (k1x1 dfo axis) ==="
duet_cell db16_k1x1_d4p1 16 1 1 4 1 16
duet_cell db32_k1x1_d4p1 32 1 1 4 1 32
echo "[$(date -Is)] === EDGE ALL DONE ==="
