#!/usr/bin/env bash
# M4 B=2 end-to-end smoke — champion E9K24_jit config, b=2 ns=8 out=128.
set -euo pipefail
ROOT="/home/chokwans99/PSD/ssd"
OUT="${ROOT}/experiments/proxy_async_overlap/b_gt1/m4_smoke_b2"
PY="/home/chokwans99/anaconda3/envs/ssd/bin/python"
cd "${ROOT}"
export CUDA_VISIBLE_DEVICES=0,1,2,3,4
export SSD_DIST_PORT=12895
