#!/usr/bin/env bash
# KV-promo smoke — champion config + SSD_DUET_KV_PROMO=1 SSD_DUET_KV_PROMO_DEBUG=1, short run.
...
sleep 5
SSD_FORCE_SPLIT_K1K2=1 SSD_DUET_JIT_SHORT=1 SSD_DUET_KV_PROMO=1 SSD_DUET_KV_PROMO_DEBUG=1 \
