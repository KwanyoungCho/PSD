...
run_one () {
  local label="$1" po="$2" port="$3"
  SSD_TREE_PLAN_ONCE=$po SSD_DIST_PORT=$port $PY -O bench/bench.py --llama --size 8 \
...
run_one bisect_po0 0 13992
run_one bisect_po1 1 13993
echo BISECT_DONE
